...
Este projeto é uma aplicação web frontend. O objetivo é fornecer um site de vendas de carros, proporcionando uma interface de usuário intuitiva. Ele foi desenvolvido utilizando as melhores práticas de desenvolvimento web e tecnologias modernas.
...
Você pode acessar o projeto clicando [aqui](https://luamelosilva.github.io/Bald-Cars/).
